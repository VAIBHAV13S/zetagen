...
export const useSEO = (config: SEOConfig) => {
  useEffect(() => {
    // Update title
    if (config.title) {
      document.title = `${config.title} | ZetaGen AI`;
    }
...
const updateStructuredData = (config: SEOConfig) => {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": config.title || "ZetaGen AI",
    "description": config.description || "AI-powered digital asset generator",
    "url": config.canonical || window.location.href,
    "isPartOf": {
      "@type": "WebSite",
      "name": "ZetaGen AI",
      "url": "https://zetagen-ai.com"
    },
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://zetagen-ai.com/gallery?search={search_term_string}",
...
export const seoConfigs = {
  home: {
    ...
    ogTitle: "ZetaGen AI | Create & Mint AI-Powered NFTs on ZetaChain",
  ...
  generator: {
    ...
    ogTitle: "AI Asset Generator | ZetaGen AI",
  ...
  gallery: {
    ...
    ogTitle: "NFT Gallery | ZetaGen AI",
    ...
    canonical: "https://zetagen-ai.com/gallery"
  }
};
